...
function SidebarItem({
 ...
 <span
 className={cn(
 "text-[10px] font-black px-1.5 py-0.5 rounded-full text-white text-center leading-none",
...
function AdminNotifDropdown({ onClose }: { onClose: () => void }) {
 ...
 <div
 ref={ref}
 className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-xl z-50 overflow-hidden"
 >
...
function AdminProfileMenu({ session }: { session: any }) {
 ...
 {open && (
 <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-xl z-50 overflow-hidden">
...
export function CommandPalette({ onClose }: { onClose: () => void }) {
 ...
 >
 <div
 className="w-full max-w-lg bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-2xl overflow-hidden"
