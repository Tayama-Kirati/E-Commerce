...
export function RegisterPage() {
 ...
 setLoading(false);
 setUser({ name:`${form.firstName} ${form.lastName}`, email:form.email, role: intendedRole as any, loyaltyPoints:150, loyaltyTier:"BRONZE" });
 showToast("Account created! Welcome to PeaNut");
 nav(intendedRole === "SELLER" ? "onboarding" : "home");
 };
