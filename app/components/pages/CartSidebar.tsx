...
export function CartSidebar() {
 ...
 className="px-6 py-2.5 bg-orange-500 text-white font-semibold text-sm rounded-xl hover:bg-orange-600 transition-colors"
 >
 Start Shopping
 </button>
 </div>
 ...
 className="flex items-center justify-center gap-2 w-full py-3.5 bg-orange-500 hover:bg-orange-600 text-white font-bold text-sm rounded-xl transition-all active:scale-[0.98]"
 >
 Proceed to Checkout →
 </button>
 <button
