...
export default function SellerOnboardingPage() {
 ...
 Welcome to the PeaNut seller community!
 </p>
 ...
 <h3 className="font-bold text-gray-900 dark:text-white">
 PeaNut Seller Agreement
 </h3>
 <p>
 By registering as a seller on PeaNut, you agree to the
 following terms:
 </p>
 <p>
 ...
 <p>
 <strong>3. Returns & Refunds</strong> — You accept PeaNut's
 7-day return policy and will process approved refunds within 3
 business days.
 </p>
 <p>
 <strong>4. Commission & Fees</strong> — PeaNut charges an 8%
 ...
 <p>
 <strong>6. Account Suspension</strong> — PeaNut reserves the
