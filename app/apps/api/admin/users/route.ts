...
export async function updateSellerStatusHandler(
  ...
  await prisma.notification.create({
    data: {
      ...
      body:
        status === "APPROVED"
          ? "Your seller account has been approved! You can now list products and start selling on NexMart."
  ...
  if (ticket) {
    await prisma.notification.create({
      data: {
        ...
        body: `NexMart support replied to your ticket: "${ticket.subject}"`,
      },
    });
  }
